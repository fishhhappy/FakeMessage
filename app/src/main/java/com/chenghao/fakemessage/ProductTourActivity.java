...
public class ProductTourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String isFirst = mySharedPreferences.getString("isFirst", "first");
        String lastVersion = mySharedPreferences.getString("lastVersion", "");
        ...
        mySharedPreferences.edit().putString("lastVersion",currentVersion).commit();
        if (isFirst.equals("first") || lastVersion.equals("") || !currentVersion.equals(lastVersion)) {
            ...
            //用putString的方法保存数据
            editor.putString("isFirst", "no_first");
            //提交当前数据
            editor.commit();
        } else {
